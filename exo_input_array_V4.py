...
""" sont saisis dans frame3
# criteres de tri et rupture du report  (before_group et after_group )  <================================ a parameter !!!!!!!!!!!!!!!!!!!!!  
#             
crit1="O"                            #<<= le 1er critere 
rang_crit1=4                         #<<= 5eme champ de la ligne ==> ville
crit1_name= entrees[rang_crit1][4]   #<<= libelle associé

crit2="O"                            #<<= le 2eme critere
rang_crit2=3                         #<<= 4eme champ de la ligne ==> age
crit2_name= entrees[rang_crit2][4]   #<<= libelle associé

crit3="N"                            #<<= le 3eme critere  ICI, que 2 utilises
rang_crit3=0                         #<<= not used ici
crit3_name= entrees[rang_crit3][4]   #<<= libelle associé
"""
